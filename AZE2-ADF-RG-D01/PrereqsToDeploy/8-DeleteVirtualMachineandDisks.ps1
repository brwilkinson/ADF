...
Get-AzureRmSubscription
 ...
 $ResourceGroup = 'AZEU2-MyOrg-rgMyAppGLOBAL'
...
Get-AzureRmVM -ResourceGroupName $ResourceGroup | Where Name -Match "APP|WEB|SQL" 

break
# Remove the VM's and then remove the datadisks, osdisk, NICs
Get-AzureRmVM -ResourceGroupName $ResourceGroup | Where Name -Match "APP"  | ForEach-Object {
    $a=$_
